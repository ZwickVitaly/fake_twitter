...
class UserDataSchemaCRUD(BaseModel):
    """
...
class AdminSchema(BaseModel):
    ...
    user_data: UserDataSchemaCRUD = Field(title="New user's data")
...
class CreatedUserSchema(DefaultPositiveResult):
    ...
    created_user_data: UserDataSchemaCRUD = Field(title="Newly created user's data")
